...
<?php
  ...
  if(isset($_POST['team1Blue'])&&isset($_POST['team2Blue'])&&isset($_POST['team3Blue'])
    ...
    $team3Red = filter($_POST['team3Red']);
		$blueEstimate=getScoreEstimate($team1Blue,$team2Blue,$team3Blue);
		$redEstimate=getScoreEstimate($team1Red,$team2Red,$team3Red);
...
<body>
  ...
  <div class="container row-offcanvas row-offcanvas-left">
    <a><h3><b><u>Red Alliance:</u></b></h3></a>
      ...
      <div class="container row-offcanvas row-offcanvas-left">
        <a><h3><b><u>Blue Alliance:</u></b></h3></a>
        <div class="well column  col-lg-12  col-sm-12 col-xs-12" id="content">
            <div class="row" style="text-align: center;">
              <div class="col-md-2">
                    Team 1:
          ...
          <div class="col-md-3">
            ...
            <button id="submit" class="btn btn-primary" onclick="postwith('');">Submit Data</button>
						<br/>
						<h1 style="margin-left:5px;"> Red Score:<spam style="color:blue"><?php echo($blueEstimate);?></spam></h1>
						<h1 style="margin-left:5px;">Blue Score:<spam style="color:red"><?php echo($redEstimate);?></spam></h1>
          </div>
					</div>
